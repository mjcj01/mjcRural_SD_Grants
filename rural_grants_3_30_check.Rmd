...
A preliminary x ~ y plot provides a starting point for analysis by visually identifying outliers. 

```{r preliminary_federal_state_plot, echo = FALSE, message = FALSE, warning = FALSE}
